...
bool Ticket::exec() {
  gGlobals.allocHeap((mSizeInfo.getPacketSize() + 31) & -32); /*Reallocate the internal heap*/
  ...
  /*Write hook branch*/
  Memory::Direct::writeBranch(gpModInfo.codehandlerHook, (u8 *)sDisc.sMetaData.mOSArenaHi + 0xA8, false); //entryhook
